...
int main(int argc, char * argv[])
{
  ...
  rclcpp::Client<std_srvs::srv::Trigger>::SharedPtr init_client =
    node->create_client<std_srvs::srv::Trigger>("/bldc_db42/init");
  rclcpp::Client<std_srvs::srv::Trigger>::SharedPtr config_client =
    node->create_client<std_srvs::srv::Trigger>("/bldc_db42/position_mode");
  rclcpp::Client<canopen_interfaces::srv::COTargetDouble>::SharedPtr target_client =
    node->create_client<canopen_interfaces::srv::COTargetDouble>("/bldc_db42/target");
