...
#include "canopen_interfaces/srv/detail/co_heartbeat_id__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const canopen_interfaces::srv::COHeartbeatID_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<canopen_interfaces::srv::COHeartbeatID_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _COHeartbeatID_Request__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const canopen_interfaces::srv::COHeartbeatID_Request *>(
...
static size_t _COHeartbeatID_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_COHeartbeatID_Request(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _COHeartbeatID_Request__callbacks = {
...
static rosidl_message_type_support_t _COHeartbeatID_Request__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_COHeartbeatID_Request__callbacks,
...
{
  return &canopen_interfaces::srv::typesupport_fastrtps_cpp::_COHeartbeatID_Request__handle;
}
...
{
  auto typed_message =
    static_cast<const canopen_interfaces::srv::COHeartbeatID_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<canopen_interfaces::srv::COHeartbeatID_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _COHeartbeatID_Response__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const canopen_interfaces::srv::COHeartbeatID_Response *>(
...
static size_t _COHeartbeatID_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_COHeartbeatID_Response(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _COHeartbeatID_Response__callbacks = {
  "canopen_interfaces::srv",
...
static rosidl_message_type_support_t _COHeartbeatID_Response__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_COHeartbeatID_Response__callbacks,
  get_message_typesupport_handle_function,
};
...
{
  return &canopen_interfaces::srv::typesupport_fastrtps_cpp::_COHeartbeatID_Response__handle;
}
...
static service_type_support_callbacks_t _COHeartbeatID__callbacks = {
  "canopen_interfaces::srv",
  "COHeartbeatID",
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, canopen_interfaces, srv, COHeartbeatID_Request)(),
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, canopen_interfaces, srv, COHeartbeatID_Response)(),
...
static rosidl_service_type_support_t _COHeartbeatID__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_COHeartbeatID__callbacks,
...
{
  return &canopen_interfaces::srv::typesupport_fastrtps_cpp::_COHeartbeatID__handle;
}
