...
bool canopen_interfaces__msg__co_data__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("canopen_interfaces.msg._co_data.COData", full_classname_dest, 38) == 0);
  }
  canopen_interfaces__msg__COData * ros_message = _ros_message;
  {  // index
...
{
  /* NOTE(esteve): Call constructor of COData */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("canopen_interfaces.msg._co_data");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "COData");
