...
class Metaclass_COWriteID_Request(type):
    ...
    def CANOPEN_DATATYPE_INT8(self):
        ...
        return Metaclass_COWriteID_Request.__constants['CANOPEN_DATATYPE_INT8']

    @property
    def CANOPEN_DATATYPE_INT16(self):
        """Message constant 'CANOPEN_DATATYPE_INT16'."""
        return Metaclass_COWriteID_Request.__constants['CANOPEN_DATATYPE_INT16']

    @property
    def CANOPEN_DATATYPE_INT32(self):
        """Message constant 'CANOPEN_DATATYPE_INT32'."""
        return Metaclass_COWriteID_Request.__constants['CANOPEN_DATATYPE_INT32']

    @property
    def CANOPEN_DATATYPE_UINT8(self):
        """Message constant 'CANOPEN_DATATYPE_UINT8'."""
        return Metaclass_COWriteID_Request.__constants['CANOPEN_DATATYPE_UINT8']

    @property
    def CANOPEN_DATATYPE_UINT16(self):
        """Message constant 'CANOPEN_DATATYPE_UINT16'."""
        return Metaclass_COWriteID_Request.__constants['CANOPEN_DATATYPE_UINT16']

    @property
    def CANOPEN_DATATYPE_UINT32(self):
        """Message constant 'CANOPEN_DATATYPE_UINT32'."""
        return Metaclass_COWriteID_Request.__constants['CANOPEN_DATATYPE_UINT32']
    ...
    def nodeid(self, value):
        if __debug__:
            ...
            assert value >= -128 and value < 128, \
                "The 'nodeid' field must be an integer in [-128, 127]"
        self._nodeid = value
