...
static rosidl_typesupport_introspection_c__MessageMember canopen_interfaces__srv__COWrite_Request__rosidl_typesupport_introspection_c__COWrite_Request_message_member_array[3] = {
  {
    "index",  // name
