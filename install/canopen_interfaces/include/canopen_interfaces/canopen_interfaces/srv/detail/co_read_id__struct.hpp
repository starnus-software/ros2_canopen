...
constexpr uint8_t COReadID_Request_<ContainerAllocator>::CANOPEN_DATATYPE_INT8;
#endif  // __cplusplus < 201703L
#if __cplusplus < 201703L
// static constexpr member variable definitions are only needed in C++14 and below, deprecated in C++17
template<typename ContainerAllocator>
constexpr uint8_t COReadID_Request_<ContainerAllocator>::CANOPEN_DATATYPE_INT16;
#endif  // __cplusplus < 201703L
#if __cplusplus < 201703L
// static constexpr member variable definitions are only needed in C++14 and below, deprecated in C++17
template<typename ContainerAllocator>
constexpr uint8_t COReadID_Request_<ContainerAllocator>::CANOPEN_DATATYPE_INT32;
#endif  // __cplusplus < 201703L
#if __cplusplus < 201703L
// static constexpr member variable definitions are only needed in C++14 and below, deprecated in C++17
template<typename ContainerAllocator>
constexpr uint8_t COReadID_Request_<ContainerAllocator>::CANOPEN_DATATYPE_UINT8;
#endif  // __cplusplus < 201703L
#if __cplusplus < 201703L
// static constexpr member variable definitions are only needed in C++14 and below, deprecated in C++17
template<typename ContainerAllocator>
constexpr uint8_t COReadID_Request_<ContainerAllocator>::CANOPEN_DATATYPE_UINT16;
#endif  // __cplusplus < 201703L
#if __cplusplus < 201703L
// static constexpr member variable definitions are only needed in C++14 and below, deprecated in C++17
template<typename ContainerAllocator>
constexpr uint8_t COReadID_Request_<ContainerAllocator>::CANOPEN_DATATYPE_UINT32;
#endif  // __cplusplus < 201703L
